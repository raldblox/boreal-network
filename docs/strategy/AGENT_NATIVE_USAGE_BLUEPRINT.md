...
- a named Boreal agent can read a prepared application packet and submit its included `submissionPreflight.preflightRequest` to the validation-only preflight endpoint before deciding whether a governed mutation route is safe to attempt
