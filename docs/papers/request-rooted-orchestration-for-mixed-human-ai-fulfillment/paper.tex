...
\input{sections/request-rooted-model}

\section{Core Invariants}
\input{sections/core-invariants}

\section{Lead-First Orchestration}
\input{sections/lead-first-orchestration}

\section{Embodied Work Representation}
\input{sections/embodied-work}

\section{Durable and Ephemeral Boundaries}
\input{sections/durable-vs-ephemeral}
