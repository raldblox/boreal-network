...
- `pnpm contracts:agent-sandbox` validates sandbox fixture coverage for inspect, make-request, apply, submit, monitor, run, signed webhook, optimize, replay, paid-run shape, and idempotent recovery flows
